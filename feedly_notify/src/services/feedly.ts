...
const FeedlyService = {
  ...
  STREAM_URL: `https://cloud.feedly.com/v3/streams/contents?streamId=user/${PropertiesService.getScriptProperties().getProperty('FEEDLY_USER_ID')}/tag/Read%20For%20Lator&count=90`,
